    ...
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white/95 backdrop-blur-md border-t border-gray-200 px-4 py-3 shadow-2xl shadow-black/10">
        <div className="flex gap-2.5">
          <a
            href="tel:0749792333"
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg border border-gray-300 text-gray-900 text-sm font-semibold"
          >
          ...
          <a
            href="/quote"
            className="flex-[2] flex items-center justify-center gap-2 py-3 rounded-lg text-sm font-semibold text-gray-900 bg-gold"
          >
            Get a Quote
