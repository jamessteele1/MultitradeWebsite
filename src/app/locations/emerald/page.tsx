    ...
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-14 md:py-20">
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-center">
            <div className="lg:col-span-3">
              ...
              <p className="text-white/60 mt-4 text-lg max-w-lg leading-relaxed serif">Our Emerald regional depot provides rapid access to the Bowen Basin coal mines and Central Highlands operations. Established during the basin's expansion, we deliver buildings cost-effectively with quick maintenance turnaround.</p>
      ...
      <section className="py-14" style={{ background: "linear-gradient(135deg, var(--navy), var(--navy-2))" }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white">Need Portable Buildings in Emerald?</h2>
