    ...
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-14 md:py-20">
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-center">
            <div className="lg:col-span-3">
              ...
              <p className="text-white/60 mt-4 text-lg max-w-lg leading-relaxed serif">Servicing Rockhampton and surrounds from our Gladstone headquarters — under 2 hours door-to-door. Full range of portable buildings for the regions construction, mining, and agricultural industries.</p>
      ...
      <section className="py-14" style={{ background: "linear-gradient(135deg, var(--navy), var(--navy-2))" }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white">Need Portable Buildings in Rockhampton?</h2>
