...
const PRODUCTS = [
  { id: "12x3m-crib-room", name: "12x3m Crib Room", size: "12x3m", capacity: "Up to 20", selfContained: false, mobile: false, img: "/images/products/12x3-crib-room/1.jpg", description: "Spacious break facility for larger crews. Full kitchenette, dual AC, and LED lighting.", features: ["2 × 3.5kW AC units", "Full kitchenette", "Seating for 20", "LED lighting"], badge: "POPULAR" },
  { id: "6x3m-crib-room", name: "6x3m Crib Room", size: "6x3m", capacity: "Up to 10", selfContained: false, mobile: false, img: "/images/products/6x3-crib/1.jpg", description: "Versatile and durable portable break space. TECO AC, kitchenette, commercial vinyl flooring.", features: ["1 × 3.9kW AC", "1200mm kitchenette", "Commercial vinyl", "Insulated walls"], badge: null },
  ...
  { id: "solar-facility", name: "Solar Facility", size: "Custom", capacity: "Off-grid power", selfContained: true, mobile: false, img: "/images/products/solar-facility/1.jpg", description: "Off-grid solar power system with 8.85kW PV array and 32.8kWh lithium phosphate battery. Eliminates diesel generators.", features: ["8.85kW PV array", "32.8kWh lithium battery", "No diesel required", "ESG compliant"], badge: "SOLAR" },
];
              ...
              <div key={i} className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-gray-300 hover:shadow-xl hover:shadow-black/5 transition-all duration-400">
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-2.5 pt-3 border-t border-gray-100">
                    <Link href={`/hire/crib-rooms/${p.id}`} className="text-center py-2.5 rounded-lg text-sm font-semibold text-gray-700 border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all flex items-center justify-center gap-1.5">
                      See Details
