...
const SERVICES = [
  { title: "Portable Building Installation", tag: "Installation", desc: "Full installation from site preparation through to commissioning. Engineering, certification, project management, and co-ordination of all trades.", features: ["Site compliant safety systems", "Engineering & certification", "Project management", "Transport & logistics", "Crane lift & positioning", "Electrical connection & testing"], img: "/images/buildings-web/_CWM6231.jpg" },
  { title: "Transport & Logistics", tag: "Transport", desc: "Reliable delivery across Queensland with established logistics partners. Table top, Hiab crane, drop deck, and barge options.", features: ["Table top & semi-trailer", "Hiab crane (5-8m reach)", "Drop deck / extendable tray", "Barge to Curtis Island", "Remote site coordination", "Multi-building convoys"], img: "/images/buildings-web/_CWM6271-Edit.jpg" },
  { title: "Custom Manufacturing", tag: "Design & Build", desc: "In-house design and fabrication in our Gladstone facility. From mobile crib rooms to server rooms and fire safe control rooms.", features: ["In-house design team", "Steel fabrication workshop", "Electrical fit-out & testing", "Custom floor plans", "Specialist builds", "Quality audits & ITPs"], img: "/images/buildings-web/_CWM6104.jpg" },
  { title: "Building Services & Maintenance", tag: "Maintenance", desc: "Carpentry, steel fabrication, painting, concreting, plumbing, and electrical through Multitrade (QBCC 20298).", features: ["Carpentry & renovations", "Steel fabrication", "Painting & decorating", "Concreting & civil works", "Plumbing services", "Ongoing fleet maintenance"], img: "/images/buildings-web/_CWM5926.jpg" },
];
