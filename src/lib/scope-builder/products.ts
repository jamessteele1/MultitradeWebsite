export type ScopeProductCategory =
  | "office"
  | "crib"
  | "ablution"
  | "complex"
...
export const MBH_PRODUCTS: ScopeProduct[] = [
  ...
  {
    id: "office-6x3-supervisor",
    name: "6x3m Supervisor Office",
    category: "office",
    recommendable: true,
  },
  {
    id: "office-self-contained-supervisor",
  ...
  {
    id: "crib-self-contained-66x3",
    name: "6.6x3m Self-Contained Crib",
    category: "crib",
    recommendable: true,
  },
  {
    id: "crib-self-contained-72x3",
  ...
  {
    id: "container-20-shelved",
    name: "20ft Shelved Container",
    category: "container",
    recommendable: true,
  },
  {
    id: "container-20-riggers",
  ...
  {
    id: "water-tank-5000-pump",
    name: "5000L Portable Water Tank on skid with pump combo",
    category: "ancillary",
    recommendable: true,
  },
  {
...
export const PRODUCT_NAME_BY_ID = new Map(
  MBH_PRODUCTS.map((product) => [product.id, product.name])
);