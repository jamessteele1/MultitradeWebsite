...
const PRODUCTS: Record<string, Product> = {
  "12x3m-office": {
    ...
    description: "The 12.0m × 3.0m Office is a spacious portable workspace designed to accommodate up to 8 workstations. With a full electrical and data fit-out, dual air conditioning units, and commercial-grade construction, this unit is the go-to solution for project management teams on mining, construction, and industrial sites across Central Queensland.",
    features: [
      { title: "Generous Workspace", desc: "36m² of open-plan or partitioned office space accommodating 6–8 desks with room for filing and storage." },
  ...
  "6x3m-office": {
    ...
    features: [
      { title: "Efficient Layout", desc: "18m² of usable office space comfortably fits 2–4 desks with room for filing cabinets and storage." },
  ...
  "gatehouse": {
    ...
    specifications: {
      "Dimensions": "10,500mm (L) × 3,400mm (W)",
  ...
  "self-contained-supervisor-office": {
    ...
    specifications: {
      "Dimensions": "6,600mm (L) × 3,000mm (W)",
      "Frame": "Steel frame construction",
      "External Cladding": "Colorbond steel",
      "Internal Lining": "Fibre cement sheet, fully insulated",
      "Flooring": "Commercial-grade vinyl",
  ...
  return (
    <>
      ...
      <section className="py-10 md:py-14 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-xl font-bold text-gray-900 mb-5">Other Site Offices</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {related.map((r, i) => (
              <Link key={i} href={`/hire/site-offices/${r.slug}`} className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-gray-300 hover:shadow-lg hover:shadow-black/5 transition-all">
