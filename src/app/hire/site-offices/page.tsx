...
const PRODUCTS = [
    { id: "12x3m-office", name: "12x3m Office", size: "12x3m", capacity: "5-6 desks", desc: "Large open-plan or partitioned office with full electrical and data fit-out.", badge: "POPULAR", img: "/images/products/12x3-office/1.jpg" },
    { id: "6x3m-office", name: "6x3m Office", size: "6x3m", capacity: "2-3 desks", desc: "Mid-size office ideal for site supervisors and project coordinators.", badge: "", img: "/images/products/6x3-office/1.jpg" },
                ...
                <div className="group bg-white rounded-xl border border-gray-200 shadow-lg shadow-black/5 overflow-hidden hover:shadow-xl hover:shadow-black/10 transition-all cursor-pointer">
                  ...
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      ...
                      <AddToQuoteButton compact showServiceUpgrades buildingSize={p.size.startsWith("12") ? "12x3" : p.size.startsWith("6") ? "6x3" : p.size.startsWith("3") ? "3x3" : "other"} product={{ id: p.id, name: p.name, size: p.size, img: p.img, category: "site-offices" }} />
                    </div>
                  </div>
                </div>
              </FadeIn>
