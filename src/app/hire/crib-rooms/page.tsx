...
const PRODUCTS = [
  { id: "12x3m-crib-room", name: "12x3m Crib Room", size: "12x3m", capacity: "Up to 20", selfContained: false, mobile: false, img: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&h=400&fit=crop", description: "Spacious break facility for larger crews. Full kitchenette, dual AC, and LED lighting.", features: ["2 × 3.5kW AC units", "Full kitchenette", "Seating for 20", "LED lighting"], badge: "POPULAR" },
  { id: "6x3m-crib-room", name: "6x3m Crib Room", size: "6x3m", capacity: "Up to 10", selfContained: false, mobile: false, img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&h=400&fit=crop", description: "Versatile and durable portable break space. TECO AC, kitchenette, commercial vinyl flooring.", features: ["1 × 3.9kW AC", "1200mm kitchenette", "Commercial vinyl", "Insulated walls"], badge: null },
  { id: "12x3m-mobile-crib", name: "12x3m Mobile Crib Room", size: "12.5x3m", capacity: "Up to 20", selfContained: true, mobile: true, img: "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=600&h=400&fit=crop", description: "Fully transportable, self-sufficient facility on a heavy-duty trailer. 11.2kVA generator and onboard water.", features: ["11.2kVA Kubota gen", "2 × 1000L water", "Air brakes & dual axles", "Mine spec"], badge: "SELF-CONTAINED" },
  { id: "6-6x3m-self-contained", name: "6.6x3m Self-Contained Crib", size: "6.6x3m", capacity: "Up to 8", selfContained: true, mobile: false, img: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&h=400&fit=crop", description: "Eliminates the need for sub trades. Ready to work straight off the truck with kitchen and water storage.", features: ["Kitchen facilities", "230L water tank", "230L grey water tank", "Storage area"], badge: "SELF-CONTAINED" },
  { id: "7-2x3m-self-contained", name: "7.2x3m Self-Contained Crib", size: "7.2x3m", capacity: "Up to 10", selfContained: true, mobile: false, img: "https://images.unsplash.com/photo-1494412574643-ff11b0a5eb19?w=600&h=400&fit=crop", description: "Larger self-contained crib with integrated bathroom. No external connections required.", features: ["Full bathroom", "Kitchen facilities", "Water storage", "Independent operation"], badge: "SELF-CONTAINED" },
  { id: "9-6x3m-living-quarters", name: "9.6x3m Living Quarters", size: "9.6x3m", capacity: "1-2 persons", selfContained: true, mobile: false, img: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=600&h=400&fit=crop", description: "Combined living and break space for remote accommodation. Sleeping quarters with kitchen and bathroom.", features: ["Sleeping quarters", "Kitchen & bathroom", "Split system AC", "Fully insulated"], badge: "ACCOMMODATION" },
];
    ...
    <>
      ...
      <section className="py-10 md:py-14">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {PRODUCTS.map((p, i) => (
              <div key={i} className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-gray-300 hover:shadow-xl hover:shadow-black/5 transition-all duration-400">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
                    <Link href="/quote" className="flex-1 text-center py-2.5 rounded-lg text-sm font-semibold text-gray-900 bg-gold hover:brightness-110 transition-all">Get a Quote</Link>
                    <Link href={`/hire/crib-rooms/${p.id}`} className="text-sm font-semibold text-gray-500 hover:text-gray-900 flex items-center gap-1">
                      Details <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                    </Link>
                  </div>
                </div>
              </div>
      ...
      <section className="py-14 md:py-20" style={{ background: "linear-gradient(135deg, var(--navy), var(--navy-2))" }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight">Not Sure Which Crib Room You Need?</h2>
          <p className="text-white/50 mt-2 serif">Tell us your crew size, site location, and project duration. We&apos;ll recommend the best solution.</p>
